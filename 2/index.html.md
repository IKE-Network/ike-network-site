...
## [#ike-starter-set](#ike-starter-set)Ike Starter Set

IkeFoundation starter set: the ledger-form content set for Ike. The source is an append-only version ledger (declared stamps, birth-FQN identity); building replays the ledger; the released artifact is a change set. Generated by ike:starter-set-create; the SOP is the dev-knowledge-set-sop topic family in ike-lab-documents.

| Version | 1-chronology-builder |
| --- | --- |
| Site | [ike.network/ike-starter-set](https://ike.network/ike-starter-set/)[22] |
| GitHub | [IKE-Network/ike-starter-set](https://github.com/IKE-Network/ike-starter-set)[23] |
...
| Version | 1 |
| --- | --- |
| Site | [ike.network/hl7-ig-corpus-example](https://ike.network/hl7-ig-corpus-example/)[26] |
| GitHub | [IKE-Network/hl7-ig-corpus-example](https://github.com/IKE-Network/hl7-ig-corpus-example)[27] |
